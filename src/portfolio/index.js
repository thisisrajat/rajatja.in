...
export function CardButton({ children, href = null }) {
  return <button onClick={goToLink(href)}>{children}</button>;
}
...
function CompilerSandox() {
  return (
    <Card>
      ...
      <CardButton href="http://compiler.rajatja.in">Live Demo</CardButton>
      <CardButton href="https://github.com/thisisrajat/compiler-sandbox">Github</CardButton>
    </Card>
  );
}
...
function CodeforcesTool() {
  return (
    <Card>
      ...
      <CardButton href="http://cftool.rajatja.in">Live Demo</CardButton>
      <CardButton href="https://github.com/thisisrajat/codeforces-tool">Github</CardButton>
    </Card>
  );
}
...
function InstagramDownloader() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/instagram-downloader">Github</CardButton>
    </Card>
  );
}
...
function VirtualStockSimulator() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/virtual-trader">Github</CardButton>
    </Card>
  );
}
...
function RadioRedditStreamer() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/radio-reddit">Github</CardButton>
    </Card>
  );
}
...
function ThisWebsite() {
  return (
    <Card>
      ...
      <CardBody>
 This website (http://rajatja.in) runs on Python's Flask framework and heavily relies on Javascript.
      </CardBody>
      <CardButton href="https://github.com/thisisrajat/rajatja.in">Github</CardButton>
    </Card>
  );
}
...
function TimeConsumedChecker() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/time-consumed">Github</CardButton>
    </Card>
  );
}
...
function Twenty() {
  return (
    <Card>
      ...
      <CardButton href="http://twenty.rajatja.in/">Live Demo</CardButton>
      <CardButton href="https://github.com/thisisrajat/twenty">Github</CardButton>
    </Card>
  );
}
...
function SublBuildSystem() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/sublime-build-system">Github</CardButton>
    </Card>
  );
}
...
function Ideone() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/ideone-compiler-api">Github</CardButton>
    </Card>
  );
}
...
function CreditCardValidator() {
  return (
    <Card>
      ...
      <CardButton href="https://github.com/thisisrajat/credit-card-validator">Github</CardButton>
    </Card>
  );
}
